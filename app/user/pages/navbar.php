    ...
    <nav class="absolute py-5 z-50 w-full h-fit inset-0 px-10 bg-black bg-opacity-30">
        <div class="flex flex-wrap items-center justify-between mx-auto">
            ...
            <div class="hidden md:flex flex-wrap items-center gap-3 justify-center mx-auto">
                <a href="dashboard" class="flex items-center"><i class="fa-solid fa-house bg-gray-900 text-gray-300 border-2 border-gray-700 rounded-lg px-4 py-2 hover:bg-gray-800 duration-200"></i></a>
                <a href="list" class="flex items-center"><i class="fa-solid fa-laptop bg-gray-900 text-gray-300 border-2 border-gray-700 rounded-lg px-4 py-2 hover:bg-gray-800 duration-200"></i></a>
            </div>
